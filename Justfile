...
doctor:
    @echo "Running diagnostics for awesome-idris2..."
...
help-me:
    @echo "=== awesome-idris2 Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/awesome-idris2/issues/new"
    @echo ""
