{
  description = "awesome-idris2 - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 awesome-idris2 development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P awesome-idris2.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/awesome-idris2 $out/bin/  # Rust
            # cp bin/awesome-idris2 $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/awesome-idris2";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-awesome-idris2" {
